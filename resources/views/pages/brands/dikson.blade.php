                    ...
                    <div class="container">
                        <div class="newsletter-container">
                            <div class="row align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <form action="{{ route('newsletter.subscribe') }}" method="POST" class="newsletter-form" id="dikson-newsletter-form">
                                        @csrf
                                        ...
                                        <div class="form-group mb-3">
                                            <input type="email" class="form-control" name="email" id="dikson-newsletter-email" placeholder="Votre adresse email" required>
                                        </div>
                                        <button type="submit" class="btn-subscribe" id="dikson-newsletter-submit">
