                            ...
                            <div class="row">
                                    ...
                                    <div class="category category-default category-rounded category-absolute overlay-zoom code-content">
                                        <a href="#">
                                            <figure class="category-media">
                                                <img src="https://muster-dikson.com/images/category/1/7/17_default.jpg" alt="Produits cosmétiques" width="280" height="280">
                                            </figure>
                                        </a>
                                        <div class="category-content">
                                            <h4 class="category-name"><a href="shop.html">SÈCHE-CHEVEUX</a></h4>
                                ...
                                <div class="col-sm-6 col-lg-3 mb-4">
                                    <div class="category category-default category-rounded category-absolute overlay-zoom">
                                        <a href="#">
                                            <figure class="category-media">
                                                <img src="https://muster-dikson.com/images/category/3/7/37_default.jpg" alt="category" width="280" height="280">
                                            </figure>
                                        </a>
                                        <div class="category-content">
                                            <h4 class="category-name"><a href="shop.html">LISSEURS DE CHEVEUX</a></h4>
                                            <a href="#" class="btn btn-primary">Voir plus</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-3 mb-4">
                                    <div class="category category-default category-rounded category-absolute overlay-zoom">
                                        ...
                                        <div class="category-content">
                                            <h4 class="category-name"><a href="shop.html">FERS À BOUCLER</a></h4>
                                            <a href="#" class="btn btn-primary">Voir plus</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6 col-lg-3 mb-4">
                                    <div class="category category-default category-rounded category-absolute overlay-zoom">
                                        ...
                                        <div class="category-content">
                                            <h4 class="category-name"><a href="shop.html">Tondeuses et coupe-bordures</a></h4>
                                            <a href="#" class="btn btn-primary">Voir plus</a>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 col-lg-3 mb-4">
                                    <div class="category category-default category-rounded category-absolute overlay-zoom">
                                        ...
                                        <div class="category-content">
                                            <h4 class="category-name"><a href="shop.html">BIOSTIMULATOR</a></h4>
                                            <a href="#" class="btn btn-primary">Voir plus</a>
                                        </div>
                                    </div>
                                </div>
